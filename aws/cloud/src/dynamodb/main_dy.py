...
def scan_dynamodb_table(table_name, config_file='config/config.json'):
...
def save_to_csv(data, table_name):
    ...
    csv_file_path = f'./exports/{table_name}.csv'
...
# Example usage
table_name = 'nu4930001-sofy-bancoagricola-pdn-sessions'

items = scan_dynamodb_table(table_name)
save_to_csv(items, table_name)